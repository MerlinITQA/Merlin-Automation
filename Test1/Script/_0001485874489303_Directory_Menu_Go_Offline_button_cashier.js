...
function _0001485874489303_Directory_Menu_Go_Offline_button_cashier()
{ 
try{
      Log.AppendFolder("_0001485874489303_Directory_Menu_Go_Offline_button_cashier");
  ...
  Button.clickOnButton(Directory_GoOffline);
   aqUtils.Delay(3000);
  AppLoginLogout.superVisorCredentialsOffline();
   aqUtils.Delay(3000);
  Button.clickOnButton(selectDirectoryButton); 
