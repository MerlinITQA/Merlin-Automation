...
function C43147_Res_receipt_format_for_CC_partial_refund()
{ 
try{
      Log.AppendFolder("C43147_Res_receipt_format_for_CC_partial_refund");
      ...
      //  cancelARefundOk.Click();
        ...
        // edit details is displayed for check payment only.
//         cancelARefundOk.Click();
           aqUtils.Delay(3000);
