...
function _0001485874473438_Res_Modify_Existing_Reduce_tickets_no_minimum_payment()
{
try{
    Log.AppendFolder("_0001485874473438_Res_Modify_Existing_Reduce_tickets_no_minimum_payment");
    InitializationEnviornment.initiliaze();
    AppLoginLogout.login();
    var groupNm="Mango new";
...
//////    }
    ...
    if(firstOrderTotal == settlementTotal){
    ...
    if(firstOrderTotal == confirmationTotal){
