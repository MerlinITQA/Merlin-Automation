...
function C17236_Opening_Passport_Exchange_from_the_home_button()
{
   InitializationEnviornment.initiliaze();
   AppLoginLogout.login();
   try {
    	Log.AppendFolder("C17236_Opening_Passport_Exchange_from_the_home_button");
...
//             }
             textnodeMenuRefunds.Click(0,0,0);
             aqUtils.Delay(1000);
            ...
            textnodeMenuReports.Click(0,0,0);
            aqUtils.Delay(1000);
