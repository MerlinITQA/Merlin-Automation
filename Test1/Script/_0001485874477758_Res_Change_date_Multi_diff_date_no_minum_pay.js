...
function _0001485874477758_Res_Change_date_Multi_diff_date_no_minum_pay()
{  
try {
	Log.AppendFolder("_0001485874477758_Res_Change_date_Multi_diff_date_no_minum_pay");
  ...
  var verifyDateFormatPrefix = aqConvert.DateTimeToFormatStr(POSObjectMapping.dt, "%#m/%#d/%Y");
  var paymentTypeForReservation = "Cash";
  
  var packageNm1 ="No Payment Required Reservation 2";
  var subPakNm1 ="Individual";
  var qtyT1 = 1;
  dt = aqDateTime.SetDateElements(2017,5, 25); 
  var dateD1 = aqConvert.DateTimeToFormatStr(dt, "%#m/%#d/%Y");
  
  placeResOrderMultiTicketQuick(false,groupNm,keyWordNm,packageNm,subPakNm,qtyT,dateD,packageNm1,subPakNm1,qtyT1,dateD1,paymentTypeForReservation);
