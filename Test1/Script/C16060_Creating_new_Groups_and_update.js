...
function C16060_Creating_new_Groups_and_update()
{
  
   try {
    	Log.AppendFolder("C16060_Creating_new_Groups_and_update");
    ...
    //  externalSysRefCode = "Test" + currentDateAndTime;      
      SelectGroupFromMainMenu.editCreatedGroup(myGroupsName,externalSysRefCode)
