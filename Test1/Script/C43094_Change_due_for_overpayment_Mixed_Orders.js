...
function C43094_Change_due_for_overpayment_Mixed_Orders()
{
try{
      Log.AppendFolder("C43094_Change_due_for_overpayment_Mixed_Orders");
     InitializationEnviornment.initiliaze();
      ...
      var temp = confirmationPageTotalNormal.Caption;
