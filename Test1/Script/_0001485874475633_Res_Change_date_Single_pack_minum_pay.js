...
function _0001485874475633_Res_Change_date_Single_pack_minum_pay()
{  
try {
	Log.AppendFolder("_0001485874475633_Res_Change_date_Single_pack_minum_pay");
 ...
 var verifyDateFormatPrefix = aqConvert.DateTimeToFormatStr(POSObjectMapping.dt, "%#m/%#d/%Y");
  placeResOrderQuick(true,groupNm,keyWordNm,packageNm,subPakNm,qtyT,dateD,paymentTypeForReservation);
