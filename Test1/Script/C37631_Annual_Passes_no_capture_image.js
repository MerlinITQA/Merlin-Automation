...
function C37631_Annual_Passes_no_capture_image()
{
try {
    Log.AppendFolder("C37631_Annual_Passes_no_capture_image");
...
//          WrapperFunction.verifyDetails(PassHolder_ResultDataGridScroller_OrderID_Row1_value,OrderHistory_Scroller_OrderID_Row1_value);
        ...
        //  Button.clickOnButton(AssignNewBarCode_Button);
          ...
          aqUtils.Delay(1000);
          Button.clickOnButton(Camera_Save_Button);
          aqUtils.Delay(1000);
          Button.clickOnButton(PrintPreview_Button);   
          aqUtils.Delay(3000);
          if(PrintPreview_Window.Exists && PrintPreview_Window.Visible){
